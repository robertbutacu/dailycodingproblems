...
object problem9 {
  ...
  * You are given an string representing the initial conditions of some dominoes. Each element can take one of three values:
  ...
  sealed trait DominoMove
  case object PushedToTheLeft extends DominoMove
  case object PushedToTheRight extends DominoMove
  case object StandingStill extends DominoMove
